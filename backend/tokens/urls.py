...
urlpatterns = [
    path('events/<int:id_event>/balance/', views.my_balance, name='my-balance'), #tested
    path('users/<str:qr_string>/<int:id_event>/', views.user_balance, name='user-balance'),
    path('users/<str:qr_string>/<int:id_event>/add/', views.add_tokens, name='add-tokens'), #tested
    path('transactions/<str:qr_string>/<int:id_attraction>/', views.new_transaction, name='new-transaction'), #tested
    path('transactions/<int:transaction_id>/', views.get_transaction, name='transaction-details'), 
    path('transactions/', views.list_transactions, name='list-transactions'), #tested
