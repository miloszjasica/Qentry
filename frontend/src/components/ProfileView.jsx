        ...
        <div className="flex justify-between items-center mb-4 md:mb-6">
          ...
          {isOrganizer && (
            <button 
              ...
              className="flex items-center gap-2 text-sm text-[#9893da] font-medium hover:text-[#7f7bc0] transition-colors"
            >
          ...
          {activeTab === 'created' && isOrganizer && (
            createdEvents.length > 0 ? (
              ...
              <div className="text-center py-12">
                ...
                <button
                  onClick={onCreateClick}
                  className="mt-4 px-4 py-2 bg-[#9893da] text-white rounded-lg hover:bg-[#7f7bc0] transition-colors"
                >
